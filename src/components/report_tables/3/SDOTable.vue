<template>
    ...
    <div class="q-pa-sm q-gutter-sm">
      <q-table title="Работа по созданию и внедрению СДО" :hide-no-data="true" :data="getRows1" :columns="getColumns1">
              ...
              <q-card class="add-row-dialog">
                ...
                <q-card-section class="">
                  <div class="row q-gutter-md q-ma-md">
                    <q-input  type="textarea" clearable v-model="getEditedItem1.name" label="Наименование курса и степень внедрения его в учебный процесс"></q-input>
                  </div>
                </q-card-section>
