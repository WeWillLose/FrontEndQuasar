<template>
    ...
    <div class="q-pa-sm q-gutter-sm">
      <q-table title="Сопровождение обучающихся с ОВЗ" :hide-no-data="true" :data="getRows1" :columns="getColumns1">
              ...
              <q-card class="add-row-dialog">
                ...
                <q-card-section class="">
                  <div class="row q-gutter-md q-ma-md">
                    <q-input  type="text" clearable v-model="getEditedItem1.role" label="Роль преподавателя в сопровождении обучающихся в учебном процессе и внеклассной работе"></q-input>
                  </div>
          ...
          <q-tr :props="props">
            ...
            <q-td key="score" :props="props">
              <q-input type="number" v-model="props.row.score"
                       :rules="[rules.withoutSpaces(),rules.numberBetweenNotStrictScore(1,2)]" dense autofocus></q-input>
            </q-td>
...
export default {
  ...
  methods: {
    ...
    close () {
      ...
      setTimeout(() => {this.$store.commit('obz/setDefault1')}, 300)
    }
  },
  data() {
    return {
