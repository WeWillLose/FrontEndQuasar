<template>
    ...
    <div class="q-pa-sm q-gutter-sm">
      <q-table title="Наличие предметного кружка, эффективность его работы" :hide-no-data="true" :data="getRows1" :columns="getColumns1">
              ...
              <q-card class="add-row-dialog">
                ...
                <q-card-section class="">
                  <div class="row q-gutter-md q-ma-md">
                    <q-input  type="text" clearable v-model="getEditedItem1.group" label="Предметный кружок (клуб, секция, студия)"></q-input>
                    <q-input  type="number" clearable v-model="getEditedItem1.students" label="Количество
                    студентов"></q-input>
                    <q-input  type="number" clearable v-model="getEditedItem1.lessons" label="Количество занятий"></q-input>
                  </div>
                </q-card-section>
